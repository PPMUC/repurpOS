...
!(function (t, e) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.VueTouchKeyboard = e())
    : (t.VueTouchKeyboard = e());
})(this, function () {
  return (function (t) {
    function e(r) {
    ...
    function (t, e) {
      t.exports = function (t, e, n, r) {
        ...
        if (
          (e &&
            ((c.render = e.render), (c.staticRenderFns = e.staticRenderFns)),
          n && (c._scopeId = n),
          r)
        ) {
    ...
    function (t, e, n) {
      ...
      e["default"] = {
        props: {
          ...
          defaultKeySet: { type: String, default: "default" },
          accept: Function,
          cancel: Function,
          change: Function,
          next: Function,
        ...
        data: function () {
          return { currentKeySet: this.defaultKeySet, inputScrollLeft: 0 };
        },
        computed: {
          keySet: function p() {
                    ...
                    t.split(" ").forEach(function (t) {
                      if ((0, l["default"])(t)) r.push(t);
                        ...
                        if (
                          ...
                          n[e]
                            ? r.push(n[e])
                            : console.warn("Missing named key from meta: " + e);
                        } else
                          "" == t
                            ? r.push({ placeholder: !0 })
                            : r.push({ key: t, text: t });
                    }),
                      e.push(r);
                  }),
        ...
        methods: {
          getLayout: function () {
            return (0, a["default"])(this.layout)
              ? c["default"][this.layout]
              : this.layout;
          },
          ...
          getClassesOfKey: function (t) {
            ...
            return (
              t.keySet && this.currentKeySet == t.keySet && (e += " activated"),
              e
            );
          },
          getKeyStyle: function (t) {
            if (t.width) return { flex: t.width };
          },
          ...
          getCaret: function () {
            ...
            return { start: e.length, end: e.length };
          },
          backspace: function (t, e) {
            return (
              t.start < t.end
                ? (e = e.substring(0, t.start) + e.substring(t.end))
                : ((e = e.substring(0, t.start - 1) + e.substring(t.start)),
                  (t.start -= 1)),
              (t.end = t.start),
              e
            );
          ...
          insertChar: function (t, e, n) {
            return (
              (e =
                t.start < t.end
                  ? e.substring(0, t.start) + n.toString() + e.substring(t.end)
                  : e.substr(0, t.start) + n.toString() + e.substr(t.start)),
              (t.start += n.length),
              (t.end = t.start),
              e
            );
            ...
            if (this.input) {
              ...
              if (o) {
                if (
                  ...
                  r.length < this.input.maxLength
                )
                  if (this.options.useKbEvents) {
                    var u = document.createEvent("Event");
                    u.initEvent("keydown", !0, !0),
                      (u.which = u.keyCode = o.charCodeAt()),
                      this.input.dispatchEvent(u) &&
                        (r = this.insertChar(n, r, o));
                  } else r = this.insertChar(n, r, o);
                "shifted" == this.currentKeySet && this.changeKeySet("default");
              }
              (this.input.value = r),
                this.setFocusToInput(n),
                this.change && this.change(r, o),
                this.input.maxLength > 0 &&
                  r.length >= this.input.maxLength &&
                  this.next &&
                  this.next(),
                this.input.dispatchEvent(new Event("input", { bubbles: !0 }));
            }
          },
          setFocusToInput: function (t) {
            this.input.focus(),
              t &&
                ...
                ((this.input.selectionStart = t.start),
                (this.input.selectionEnd = t.end));
          },
        },
        mounted: function () {
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n, x, g, S, m) {
        ...
        var O,
          ...
          K = "Array" == e ? T.entries || C : C;
        if (
          (K &&
            ((w = l(K.call(new t()))),
            w !== Object.prototype &&
              w.next &&
              (f(w, _, !0), r || c(w, p) || u(w, p, b))),
          E &&
            C &&
            C.name !== v &&
            ((L = !0),
          ...
          if (
            ((O = { values: E ? P : j(v), keys: S ? P : j(d), entries: M }), m)
          )
            for (k in O) k in T || i(T, k, O[k]);
    ...
    function (t, e, n) {
      ...
      t.exports =
        ...
        function (t, e) {
          ...
          return (
            null !== t
              ? ((c[s] = r(t)), (n = new c()), (c[s] = null), (n[u] = t))
              : (n = a()),
            void 0 === e ? n : o(n, e)
          );
        };
    ...
    function (t, e, n) {
      n(59), n(69), n(70), n(71), (t.exports = n(16).Symbol);
    },
    function (t, e, n) {
      "use strict";
      var r = n(15),
        ...
        Q = function (t, e) {
          x(t);
          for (var n, r = v((e = S(e))), o = 0, i = r.length; i > o; )
            Y(t, (n = r[o++]), e[n]);
          return t;
        },
        q = function (t, e) {
        ...
        X = function (t) {
          var e = I.call(this, (t = m(t, !0)));
          return (
            !(this === G && o(D, t) && !o(V, t)) &&
            (!(e || !o(this, t) || !o(D, t) || (o(this, A) && this[A][t])) || e)
          );
        },
        Z = function (t, e) {
          if (((t = S(t)), (e = m(e, !0)), t !== G || !o(D, e) || o(V, e))) {
            var n = L(t, e);
            return (
              !n || !o(D, e) || (o(t, A) && t[A][e]) || (n.enumerable = !0), n
            );
          }
        },
        $ = function (t) {
          for (var e, n = C(S(t)), r = [], i = 0; n.length > i; )
            o(D, (e = n[i++])) || e == A || e == s || r.push(e);
          return r;
        },
        tt = function (t) {
          for (
            var e, n = t === G, r = C(n ? V : S(t)), i = [], u = 0;
            r.length > u;

          )
            !o(D, (e = r[u++])) || (n && !o(G, e)) || i.push(D[e]);
          return i;
        };
      H ||
        ((P = function () {
          ...
          return i && z && B(G, t, { configurable: !0, set: e }), J(t);
        }),
        c(P[F], "toString", function () {
          return this._k;
        }),
        (j.f = Z),
        (_.f = Y),
        ...
        (n(64).f = X),
        (n(63).f = tt),
        i && !n(13) && c(G, "propertyIsEnumerable", X, !0),
        (y.f = function (t) {
          return J(h(t));
        })),
        u(u.G + u.W + u.F * !H, { Symbol: P });
      for (
        var et =
    ...
    function (t, e, n) {
      var r = n(45)("meta"),
        ...
        h = function (t) {
          return a && y.NEED && s(t) && !i(t, r) && f(t), t;
        },
        y = (t.exports = {
          KEY: r,
          NEED: !1,
      ...
      t.exports = {
        render: function () {
          var t = this,
            e = t.$createElement,
            n = t._self._c || e;
          return n("div", { staticClass: "vue-touch-keyboard" }, [
            n(
              "div",
              ...
              t._l(t.keySet, function (e, r) {
                return n(
                  "div",
                  { key: r, staticClass: "line" },
                  t._l(e, function (e, r) {
                    return n("span", {
                      key: r,
                      class: t.getClassesOfKey(e),
                      style: t.getKeyStyle(e),
                      domProps: { textContent: t._s(t.getCaptionOfKey(e)) },
                      on: {
                        click: function (n) {
                          return t.clickKey(n, e);
                        },
