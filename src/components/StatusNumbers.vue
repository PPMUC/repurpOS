  ...
  >
    ...
    >
      ...
      <div class="uk-flex uk-margin-xlarge-top uk-padding-small uk-width-1-2 ">
          <button class="uk-button uk-button-large uk-button-danger uk-width-1-1 button-padding">
                <span class="uk-text uk-width-1-1">Grind</span>
          </button> 
      </div>
      <div class="uk-flex uk-margin-xlarge-top uk-padding-small uk-width-1-2 ">
        <button class="uk-button uk-button-large uk-button-danger uk-width-1-1 button-padding">
                <span class="uk-text uk-width-1-1">New</span>
          </button> 
      </div>
    </div>
  </div>
